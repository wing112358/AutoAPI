...
public class AddMealTest extends BaseTest {
    ...
    public Integer addMeal(AddMealReq param, String result) throws IOException {
        log.info("-----------------------------------------开始发起addMeal请求--------------------------------------------------------");

        //清理历史数据
        Integer deleteresult = deleteMealDataByName(param,loginheader);
...
//        AddMealReq addmealparam=new AddMealReq(json.getString("duration"),list,null,json.getString("name"));
    ...
    public  Integer deleteMealDataByName(AddMealReq param,Header[] header) throws IOException {
