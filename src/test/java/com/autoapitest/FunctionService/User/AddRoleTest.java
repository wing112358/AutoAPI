...
public class AddRoleTest extends BaseTest {
    ...
    public Header[] getHeaders(){
        ...
        this.loginheader = new LoginTest().loginNormal(comsumerinfo.getString("phone"),"8888","123456",1);
    ...
    public JSONObject addRole(AddRoleReq param, String result) throws IOException {
        log.info("-----------------------------------------开始发起addRole请求--------------------------------------------------------");

        //清理历史数据
        Integer deleteresult = deleteRoleDataByName(param,loginheader);
    ...
    public  Integer deleteRoleDataByName(AddRoleReq param,Header[] header) throws IOException {
