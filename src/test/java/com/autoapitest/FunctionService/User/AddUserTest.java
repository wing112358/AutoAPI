...
public class AddUserTest extends BaseTest {
    ...
    public Header[] getHeaders(){
        ...
        this.loginheader = new LoginTest().loginNormal(phone,"8888","123456",1);
    ...
    public JSONObject addUser(AddUserReq param, String result) throws IOException {
        log.info("-----------------------------------------开始发起addUser请求--------------------------------------------------------");

        //清理历史数据
        Integer deleteresult = deleteUserDataByName(param,loginheader);
    ...
    public  Integer deleteUserDataByName(AddUserReq param,Header[] header) throws IOException {
        //获取id
