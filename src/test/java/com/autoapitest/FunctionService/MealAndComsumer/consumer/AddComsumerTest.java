...
public class AddComsumerTest extends BaseTest {
    ...
    public Header[] getHeaders(){
        ...
        this.loginheader = new LoginTest().loginNormal("adminplatform","8888","123456",0);
    ...
    public JSONObject addComsumer(AddConsumerReq param, String result) throws IOException {
        log.info("-----------------------------------------开始发起addComsumer请求--------------------------------------------------------");

        //清理历史数据
        Integer deleteresult =deleteDataByName(param,loginheader);
    ...
    public  Integer deleteDataByName(AddConsumerReq param,Header[] header) throws IOException {
