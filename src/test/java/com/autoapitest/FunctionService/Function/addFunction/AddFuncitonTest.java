...
public class AddFuncitonTest extends LoginTest {
    ...
    public Header[] getHeaders(){
        ...
        this.loginheader = new LoginTest().loginNormal("admindev","8888","123456",0);
    ...
    public List<Integer> addFunctionNormal(AddFunctionReq param, String result) throws IOException {

        log.info("-----------------------------------------开始发起addFunctionNormal请求--------------------------------------------------------");

        //清理历史数据
        Integer deleteflag=deletedata(param,loginheader);
    ...
    public List<Integer> addPage(AddFunctionReq param,String result) throws IOException {
...
//        Header[]  loginheader = new LoginTest().loginNormal("admindev","8888","123456",0);
    ...
    public List<Integer> addButton(AddFunctionReq param,String result) throws IOException {
...
//        Header[]  loginheader = new LoginTest().loginNormal("admindev","8888","123456",0);
     ...
     * @return
     */
    public Integer deletedata(AddFunctionReq request,Header[] headers) throws IOException {
